...
namespace Helpers.Events.Triggering
{
    ...
    public class TriggerMmEvent : MonoBehaviour
    {
        ...
        private bool IsOverview => Kind == MmEventKind.OverviewLocation;
        ...
        public void TriggerNow()
        {
            switch (Kind)
            {
                ...
                case MmEventKind.Docking:
                    DockingEvent.Trigger(dockingType, dockingDock); // Dock can be null for Undock/Unset
                    break;
                ...
                case MmEventKind.Alert:
                    AlertEvent.Trigger(alertReason, alertMessage, alertTitle, alertVariant, 3f, alertIcon, alertSound
                    );
                    break;
                ...
                case MmEventKind.OverviewLocation:
                    OverviewLocationEvent.Trigger(overviewLocationType, locationActionType, overviewLocationId,
                        cameraTransform);
                    break;
            }
        }
